...
func (h *handlerAuth) CheckAuth(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, resultdto.SuccesResult{Status: "Success", Data: registery{Data: convertCheckOutResponse(user)}})
}

func convertCheckOutResponse(u models.User) authdto.CheckOutResponse {
	return authdto.CheckOutResponse{
		ID:       u.ID,
		Fullname: u.Fullname,
		Username: u.Username,
		Email:    u.Email,

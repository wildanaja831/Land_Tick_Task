  ...
  return (
    <Navbar className="bg-body-tertiary shadow">
      <Container>
        <Navbar.Brand>
          <Link
            to={state.user.role === "admin" ? "/admin" : "/"}
            style={{ textDecoration: "none" }}
          >
            <img src={LogoName} alt=".." style={{ width: 100 }} />{" "}
        ...
        <Navbar.Collapse className="justify-content-end">
              ...
              {state.user.role == "admin" ? (
                <div>
                  <Button
                    onClick={handleOpen}
                    className="border-0"
                    style={{ backgroundColor: "transparent", color: "#ED7A9D" }}
                  >
                    Admin{" "}
                    <img
                      className="p-2 ms-1 rounded-circle border border-2"
                      alt=".."
                      style={{ width: 40, borderColor: "#ED7A9D" }}
                      src={DefaultProfile}
                    />
                  </Button>
                  {open && (
                    <div>
                      <ul
                        className="position-absolute shadow bg-light p-1 rounded"
                        style={{ top: 80, listStyle: "none" }}
                      >
          ...
          <ModalLogin
            show={modalLoginShow}
            showLogin={setModalLoginShow}
            showRegister={setModalRegisterShow}
